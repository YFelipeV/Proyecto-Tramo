    ...
    <div className="mt-6">
      ...
      <div className="mt-3 d-flex justify-content-center flex-column container w-md-75">
        ...
        <div className="w-100 d-flex justify-content-center">
          <p className="text-center text-justify mt-4 fs-5 font text-secondary w-sm-100 w-md-75 ">TRAMO es una aplicación que busca conectar de forma más
            fácil y
            segura a las personas que requieren de un servicio de transporte de carga para sus productos, No
            solamente con enfoque en las ciudades, sino que también en el campo, debido a que en el departamento
            del Cauca cerca del 60% de la población pertenece a zonas rurales.</p>
        </div>
      </div>
    </div>
    </section>
        ...
        <div className="row align-items-center">
          <div className="col-md-5 text-center text-md-start order-1">
            <img className="img-fluid mb-4"
              src={ilu1} width="650" alt=""></img>
              </div>
          <div className="col-md-6 text-center text-md-start offset-md-1 order-2">
            <h6 className="fw-bold fs-2 lh-sm text-sm-center text-md-start dark">Mision
              <br />
            </h6>
            <p className="my-4 pe-xl-5 fon text-justify fs-5  text-secondary">
              ...
              del Cauca, vinculando el sector transporte para impulsar su economía del sector.</p> </div>
          </div>
        </div>
    ...
    <section className="py-6 font my-5">
          <div className="container">
            <div className="row  text-md-start offset-md-1">
              <div className="col-sm-12 col-md-6 order-sm-3 order-md-1 text-center text-md-start">
                <h6 className="fw-bold fs-2  X f lh-sm mt-5  text-sm-center text-md-start dark">Vision</h6>
              ...
              <div className="col-sm-12 col-md-6 order-md-2 order-sm-2  text-center">
                <img className=" img-fluid w-lg-75" src={ilu2} width="350" alt="" ></img>
              </div>
            </div>
          </div>
        </section>
         ...
         <section className='font mt-5 py-5 '>
          <div className="container">
            <div className="row text-md-start offset-md-1">
              <div
                className="col-sm-12 col-md-6  order-sm-2  order-md-1 d-flex justify-content-center align-items-start justify-content-md-start ">
                <img className="img-fluid mt-3 m-md-0 w-sm-100 w-md-75  " src={ilu3} alt=""style={{ maxWidth:"390px"}}></img>
              </div>
