      ...
      <div className="container position-relative  mt-5">
        <div className="row align-items-center ">
          <div className="col-md-5 col-lg-6 order-md-1 text-center">
            <img className="img-fluid" src={imagen1}  style={{ maxWidth:"270px"}}  alt=""></img>
          </div>
          <div className="col-md-7 col-lg-6 text-center text-md-start"><span
              className="badge bg_gray rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-100 w-sm-50 w-md-75 w-xl-0 my-3 ">
              APP #1
              Transporte De Carga 2023
              <img className="img-fluid float-start me-4"
                src={imagen2}  alt=""></img></span>
            <h1 className="mb-4 display-5 fw-bold lh-sm dark">TRAMO <br className="d-block d-lg-none d-xl-block d5" />Transporte
              y
              Movilidad</h1>
            <p className="mt-3 mb-4 fs-5   gray">Solicita tu servicio desde cualquier lugar <br
                className="d-none d-lg-block fw-bold" />Descargando nuestra aplicación, disponible para Android y IOS</p>
            <div className="text-center text-md-start">
              <a className="btn btn-lg btn-success rounded-pill hover-top bg_green mt-3" href="#descarga-con">Descarga
                Gratis</a>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 mx-auto align-items-center text-center">
            <p className="mb-5 mt-1 text-secondary fs-5">Empresas que trabajan con nosotros</p>
          </div>
        </div>
        <div className="row align-items-center justify-content-center justify-content-lg-around">
          <div className="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center">
            <img src={company_1} alt=""></img></div>
          <div className="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center">
            <img src={company_2} alt="" ></img></div>
          <div className="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center">
            <img
              src={company_3} alt="" ></img></div>
          <div className="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center">
            <img
              src= {company_4}alt="" ></img></div>
          <div className="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center">
            <img
              src={company_1} alt="" ></img></div>
        </div>
      </div>
    </section>
    {/* fin section */}
     ...
     <div className="container-lg pt-2 mt-2">
       <div className="row align-items-center">
         <div className="col-md-4 col-lg-5 order-md-0  text-start mb-5 mb-md-0 conEmpresa">
            <img className="img-fluid ilustracionEmpresa"
             src={ilustracion}  style={{ maxWidth:"290px"}} alt="" ></img></div>
         <div className="col-md-8 col-lg-7 px-sm-5 px-md-0 text-start">
           <h6 className="fw-bold  fs-2 lh-sm text-start dark">Caracteristicas de la<br />App TRAMO</h6>
           <p className="my-4 text-secondary fs-5">TRAMO conecta el campo y las ciudades en una sola aplicación,<br
               className="d-none d-xl-block" />siendo la primera empresa con enfoque en el campo.</p>
           <div className="d-flex align-items-center mb-5">
             <div><img className="img-fluid" src={icon1} width="90" alt="" ></img></div>
             <div className="px-4">
               <h5 className="fw-bold text-danger">Servicios Rapidos</h5>
               <p className='text-secondary fs-5'>Encuentra los vehiculos disponibles que esten <br className="d-none d-xl-block"></br> más cerca de tu
                 ubicación.</p>
             </div>
           </div>
           <div className="d-flex align-items-center mb-5">
             <div><img className="img-fluid" src={icon2} width="90" alt="" ></img></div>
             <div className="px-4">
               <h5 className="fw-bold text-primary">Ahorro</h5>
               <p className='text-secondary fs-5'>Podrás ahorrar en tiempo y precios reduciendo <br className="d-none d-xl-block"></br>y controlando los
                 sobreprecios en los servicios<br className="d-none d-xl-block"></br> de transporte</p>
             </div>
           </div>
           <div className="d-flex align-items-center mb-5">
             <div><img className="img-fluid" src={icon3} width="90" alt="" ></img></div>
             <div className="px-4">
               <h5 className="fw-bold text-success">Desarrollo Para El Campo</h5>
               <p className='text-secondary fs-5'>Ofrecemos cobertura en en zonas urbanas y rurales<br className="d-none d-xl-block"></br>para sacarte de apuros
    ...
    <div className="container pt-md-5">
      <div className="row align-items-center">
        <div className="col-md-6 text-center text-md-start offset-md-1 mb-sm-5">
            <h6 className="fw-bold display-6 dark lh-sm">Acerca de Nosotros</h6>
                <p className="my-4  pe-xl-5 fs-6 font text-secondary "> TRAMO es una aplicación que conecta de forma más fácil, rapida y segura a las
                     personas que requieren de un servicio de transporte de carga para sus productos. 
                     No solamente con enfoque en las ciudades, sino que también en el campo,
                    debido a que en el departamento del Cauca cerca del 60% de la población pertenece a zonas rurales.</p>
                    <Link className="btn btn-lg btn-primary rounded-pill text-center hover-top   px-4 py-2 " to="/about" role="button">Ver Más</Link>
                </div>
             <div className="col-md-5 order-md-0 text-center text-md-start pt-sm-5"><img className="img-fluid acercaImg my-md-5 "
                src={acerca} width="300" alt="" ></img>
         </div>
            </div>
        </div>
    </section>
      ...
      <div className="container mt-sm-3 mt-md-5 ">
        <div className="row align-items-center">
          <div className="col-md-5 col-lg-5 order-md-1 text-center z-index-2 cta-image ">
            <img className="img-fluid mb-4 mb-md-0 img_descarga ilustracion  w-75" src={ilustracion2} alt="" ></img>
          </div>
          <div className="col-md-7 col-lg-7 text-center text-md-start">
            <h1 className="display-5 fw-bold lh-sm mt-md-8  dark">Descarga La App De Tramo</h1>
            <p className="my-4 fs-5 text-secondary"> The rise of mobile devices transforms the way we consume information entirely and the
            ...
            <div className="d-flex justify-content-center d-md-inline-block">
              ...
              <a href="!#">
                <img className="w-sm-25 w-md-50 appstore" src={appstore} alt="" ></img>
              </a>
            </div>
          </div>
        </div>
